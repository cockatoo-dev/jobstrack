...
<template>
  <div class="p-2">
    <UCard 
      class="w-72 h-56 border-4 drop-shadow-md transition-colors"
      :class="(
    ...
    >
      <NuxtLink to="/job">
        ...
        >
          <div class="absolute top-36 rounded-b left-0 w-full h-[4.5rem] pt-[0.875rem] mx-auto bg-fuchsia-300 dark:bg-fuchsia-700 border-t-2 border-t-fuchsia-300 dark:border-t-fuchsia-700 transition-opacity opacity-0 hover:opacity-100 text-center">
            <UButton 
              size='md' :disabled="!showDismiss" 
              :ui="{size:{md:'text-base font-bold'}}"
              @click="alertFunction"
            >
              Dismiss reminder
            </UButton>
